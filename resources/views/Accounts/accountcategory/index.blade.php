    ...
    <section id="main" class="main" style="padding-top: 0vh;">
      ...
      <div class="pagetitle" style="margin-left: 20px;">
          ...
          <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active"><a> Manage Account Category</a></li>
          </ol>
          </nav>
      </div>
                  ...
                  <table class="table table-border datatable " style="border: 1px solid black">
                    <thead>
                      <tr >
                        ...
                        <th scope="col">A_Category_id</th>
                        <th scope="col">Account Category</th>
                        <th scope="col">Account Category Code</th>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <th >{{ $item->id }}</a></th>
                        <td>{{ $item->cast }}</td>
                        <td><a  class="datatable-sorter"></a>{{ $item->cast_code }}</td>
                        <td>{{ $item ->detail }}</td>
                        ...
                        <td><form action="" method="POST">
                          ...
                          <a class="btn btn-primary" href="{{route('cast.edit',$item->id)}}">Edit</a>
