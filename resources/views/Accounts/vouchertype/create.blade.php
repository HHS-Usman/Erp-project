        ...
        <div class="row justify-content-center">
            <div class="col-xs-6 col-sm-6 col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="voucherid" disabled value={{$maxID}} id="voucherid" class="form-control">
                </div>

                <div class="form-group">
                    <strong>Voucher Type Title</strong>
                    <input type="text" name="vouchertitle" id="vouchertitle" class="form-control"
