...
@section('content')
    <section id="main" class="main" style="padding-top: 0vh;">
      ...
      <div class="pagetitle" style="margin-left: 20px;">
          <h1> Manage Financial Year setup</h1>
          <nav>
          <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Home</a></li>
              <li class="breadcrumb-item active"><a> Manage Financial Year setup</a></li>
          </ol>
          </nav>
      </div>
              ...
              <div class="row justify-content-center" >
                <div class="card-body">  
                  <table class="table table-border datatable " style="border: 1px solid black">
                    ...
                    <tbody>
                    @foreach ($financialyear as $financial=>$item )
                        <tr>
                          <td>{{$financial + 1 }}</td>
                          <td>{{$item->fyear_id}}</td>
                          <td>{{$item->fiscalyear_title}}</td>
