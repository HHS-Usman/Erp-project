...
@section('content')
    <section id="main" class="main" style="padding-top: 0vh;">
        ...
        <div class="pagetitle" style="margin-left: 20px;">
            <h1>Create Voucher Entries </h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
                    <li class="breadcrumb-item active"><a> Create Voucher Entries</a></li>
                </ol>
            </nav>
        </div>
        <br><br><br>
        <form action="" method="">     
            ...
            <div class="row">
                <div class="col-md-6 form-group">
                    <label for="jvdate">Select type</label>
                ...
                <div class="col-md-6">
                    <label for="journalDate">Voucher Date</label>
            ...
            <div class="row mt-3">
                <div class="col-md-6">
                    <label for="journalDate">Voucher type</label>
                    <input type="input" class="form-control" id="journalDate" name="journalDate">
                </div>
            </div>
