    ...
    <section id="main" class="main" style="padding-top: 0vh;">
        ...
        <body>
            <div class=" wrapper d-flex">
                ...
                <div class="container">
                    <form class="w-100" id="multitab-form" action="{{ route('product.store') }}"
                                ...
                                <div class="form-group  d-flex">
                                    ...
                                    <div class="form-group d-flex">
                                        <strong for="Service"> Service
                                            <input type="checkbox" name="service" id="service" class="choose"
                                                Value="Yes" onchange="handleCheckboxChange(this)">
                                        </strong>
                                    </div>
                                    <div class="form-group d-flex">
                                        <strong for="General Product">General Product
                                            <input type="checkbox" name="general_product" id="general_product"
                                                class="choose" Value="Yes" onchange="handleCheckboxChange(this)" checked>
                                        </strong>
                                    </div>
                                    <div class="form-group d-flex">
                            ...
                            <div style="padding: 10px;  border: 1px solid rgb(5, 5, 5);">
                                ...
                                <div class="container d-flex justify-content-center align-items-center"
                                    ...
                                    <div class="form-group d-flex">
                                        ...
                                        <input type="text" class="form-control" name="product_barcode"
                                            id="product_barcode" style="margin-left: -2%">
                                    </div>
                                    <div class=" d-flex" style="margin: 3%">
                                ...
                                <div class="container d-flex justify-content-center align-items-center"
                                    ...
                                    <div class="form-group d-flex">
                                        ...
                                        <input type="number" step="0.01" class="form-control" name="min_qty"
                                            id="min_qty" style="margin-left: 6%">
                                    </div>
                                </div>
                                <div class="container d-flex justify-content-center align-items-center"
                                    style="margin-bottom:-15px;">
                                ...
                                <div class="container d-flex justify-content-center align-items-center"
                                    ...
                                    <div class="form-group d-flex">
                                        ...
                                        <textarea type="text" class="form-control blue-border" name="product_description" id="product_description"
                                            placeholder="product_description" style="margin-left:-2%"></textarea>
                                    </div>
                                    <div class=" d-flex" style="margin: 3%">
                                    ...
                                    <div class="form-group d-flex">
                                        ...
                                        <select name="product_activity" id="product_activity" class="form-select"
                                            ...
                                            @foreach ($productactivities as $item)
                                                <option value="{{ $item->id }}">{{ $item->product_activity }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                        ...
                                        <div class="form-group d-flex">
                                            ...
                                            <select name="product_brand_id" id="product_brand_id" class="form-select">
                                                ...
                                                @foreach ($brandselections as $item)
                                                    <option value="{{ $item->id }}">{{ $item->brand_selection }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group d-flex">
                                            ...
                                            <select name="product_type_id" id="product_type_id" class="form-select">
                                                ...
                                                @foreach ($producttypes as $item)
                                                    <option value="{{ $item->id }}">{{ $item->product_type }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group d-flex">
                                            ...
                                            <select name="product_status_id" id="product_status_id" class="form-select">
                                                ...
                                                @foreach ($productstatuses as $item)
                                                    <option value="{{ $item->id }}">{{ $item->product_status }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group   d-flex">
                                        ...
                                        <select name="product_category_id" id="product_category_id" class="form-select"
                                            ...
                                            @foreach ($productcategories as $item)
                                                <option value="{{ $item->id }}">{{ $item->product_category }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group   d-flex">
                                        ...
                                        <select name="product_1stcategory_id" id="product_1stcategory_id"
                                            ...
                                            @foreach ($productsubs as $item)
                                                <option value="{{ $item->id }}">{{ $item->product1stsbctgry }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group d-flex">
                                        ...
                                        <select name="product_supplier_id" id="product_supplier_id" class="form-select">
                                            ...
                                            @foreach ($productsuppliers as $item)
                                                <option value="{{ $item->id }}">{{ $item->product_supplier }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="container d-flex justify-content-center align-items-center"
                                    ...
                                    <div class="form-group d-flex">
                                        ...
                                        <input type="file" name="product_image" id="product_image"
                                            class="form-control" style="margin-left:5%;">
                                    </div>
                                </div>
                                <div class="container d-flex justify-content-center align-items-center"
                                    style="margin-bottom:-5px;">
                                ...
                                <div class="container d-flex justify-content-center align-items-center"
                                    ...
                                    <div class="form-group d-flex">
                                        ...
                                        <div class="form-group d-flex">
                                            ...
                                            {{-- country --}}
                                            <input class="form-control" type="number" name="float" id="percentage"
                                                step=0.01 placeholder="0" oninput="calculateValues()">
                                            <input class="form-control" type="number" name="float_value"
                                                id="discountValue" step=0.01 placeholder="0" oninput="calculateValues()">
                                ...
                                <div class="container d-flex justify-content-center align-items-center"
                                    ...
                                    <div class="form-group   d-flex">
                                        ...
                                        <div class="form-group">
                                            ...
                                            {{-- country --}}
                                            <input type="number" step="0.01" name="product_profit"
                                                id="product_profit" class="form-control">
                                        </div>
                                    </div>
                                    <div class=" d-flex" style="margin: 3%">
                                    </div>
                                ...
                                <div class="container d-flex justify-content-center align-items-center"
                                    ...
                                    <div class="form-group d-flex">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="fur_item_tax" id="" step="0.01"
                                                placeholder="0.0">
                                        </div>
                                    </div>
