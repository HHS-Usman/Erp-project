    ...
    <section id="main" class="main" style="padding-top: 0vh;">
      ...
      <div class="pagetitle" style="margin-left: 20px;">
          ...
          <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active"><a> Manage Product Category</a></li>
          </ol>
          </nav>
      </div>
              ...
              <div class="row justify-content-center" >
                <div class="card-body">  
                  <table class="table table-border datatable " style="border: 1px solid black">
                    ...
                    <tbody>
                      @foreach ($productcategories as $productcategory =>$item )
                      <tr>
                        <th >{{ $productcategory + 1 }}</a></th>
                        <th >{{ $item->id }}</a></th>
                        <td>{{ $item->product_category }}</td>
                        <td><a  class="datatable-sorter"></a>{{ $item->product_category_code }}</td>
                        <td>{{ $item ->detail }}</td>
                        ...
                        <td><form action="" method="POST">
                          ...
                          <a class="btn btn-primary" href="{{route('productcategory.edit',$item->id)}}">Edit</a>
