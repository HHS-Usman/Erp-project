...
@section('content')
    ...
    <section id="main" class="main" style="padding-top: 0vh;">
      ...
      <div class="pagetitle" style="margin-left: 20px;">
          <h1>Manage Classification</h1>
          <nav>
          <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Home</a></li>
              <li class="breadcrumb-item active"><a> Manage Classification</a></li>
          </ol>
          </nav>
      </div>
              ...
              <div class="row justify-content-center" >
                <div class="card-body">  
                  <table class="table table-border datatable " style="border: 1px solid black">
                    ...
                    <tbody>
                      @foreach ($classifications as $classification =>$item )
                      <tr>
                        <th >{{ $classification + 1 }}</a></th>
                        <th >{{ $item->id }}</a></th>
                        <td>{{ $item->classification }}</td>
                        <td><a  class="datatable-sorter"></a>{{ $item->classification_code }}</td>
                        <td>{{ $item ->detail }}</td>
                        ...
                        <td><form action="" method="POST">
                          ...
                          <a class="btn btn-primary" href="{{route('classification.edit',$item->id)}}">Edit</a>
