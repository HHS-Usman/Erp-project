    ...
    <section id="main" class="main" style="padding-top: 0vh;">
      ...
      <div class="pagetitle" style="margin-left: 20px;">
          ...
          <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active"><a> Manage UOM</a></li>
          </ol>
          </nav>
      </div>
                  ...
                  <table class="table table-border datatable " style="border: 1px solid black">
                    <thead>
                      <tr >
                        ...
                        <th scope="col">Unit Of Measure Code</th>
                    ...
                    <tbody>
                      @foreach ($uoms as $uom =>$item )
                      <tr>
                        <th >{{ $uom + 1 }}</a></th>
                        <th >{{ $item->id }}</a></th>
                        <td>{{ $item->uom }}</td>
                        <td><a  class="datatable-sorter"></a>{{ $item->uom_code }}</td>
                        <td>{{ $item ->detail }}</td>
                        ...
                        <td><form action="" method="POST">
                          ...
                          <a class="btn btn-primary" href="{{route('uom.edit',$item->id)}}">Edit</a>
