        ...
        @endif
            <div class="pagetitle" style="margin-left: 20px;">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a> Update Product Type</a></li>
                </ol>
                </nav>
            </div>
            <br><br><br>
            <form action="{{ route('producttype.update',$producttype) }}" method="POST">        
                @csrf
                @method('PUT')
                    <div class="row justify-content-center">
                        <div class="col-xs-6 col-sm-6 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="detail" id="detail" value="{{$producttype->detail}}" class="form-control" placeholder="Detail">
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="1" name="is_active" id="is_active" {{$producttype->is_active ? 'checked' : '' }}>
