    ...
    <section id="main" class="main" style="padding-top: 0vh;">
      ...
      <div class="pagetitle" style="margin-left: 20px;">
          ...
          <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active"><a> Manage Product Type</a></li>
          </ol>
          </nav>
      </div>
              ...
              <div class="row justify-content-center" >
                <div class="card-body">  
                  <table class="table table-border datatable " style="border: 1px solid black">
                    ...
                    <tbody>
                      @foreach ($producttypes as $producttype =>$item )
                      <tr>
                        <th >{{ $producttype + 1 }}</a></th>
                        <th >{{ $item->id }}</a></th>
                        <td>{{ $item->product_type }}</td>
                        <td><a  class="datatable-sorter"></a>{{ $item->product_type_code }}</td>
                        <td>{{ $item ->detail }}</td>
