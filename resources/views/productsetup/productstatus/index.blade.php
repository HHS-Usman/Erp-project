    ...
    <section id="main" class="main" style="padding-top: 0vh;">
      ...
      <div class="pagetitle" style="margin-left: 20px;">
          ...
          <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active"><a> Manage Product Status</a></li>
          </ol>
          </nav>
      </div>
                  ...
                  <table class="table table-border datatable " style="border: 1px solid black">
                    <thead>
                      <tr >
                        ...
                        <th scope="col">P_st_id</th>
                        <th scope="col">Product Status</th>
                        <th scope="col">Product Status Code</th>
                    ...
                    <tbody>
                      @foreach ($productstatuses as $productstatus =>$item )
                      <tr>
                        ...
                        <td><form action="" method="POST">
                          ...
                          <a class="btn btn-primary" href="{{route('productstatus.edit',$item->id)}}">Edit</a>
