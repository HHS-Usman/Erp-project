        ...
        @endif
            <div class="pagetitle" style="margin-left: 20px;">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a> Create Payment Term</a></li>
                </ol>
                </nav>
            </div>
            <br><br><br>
            <form action="{{ route('paymentterm.store') }}" method="POST">        
                @csrf
                    <div class="row justify-content-center">
                        <div class="col-xs-6 col-sm-6 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="paymentterm" id="paymentterm" class="form-control" placeholder="Payment Term" required>
                            </div>
                            <div class="form-group">
