...
@section('content')
    ...
    <section id="main" class="main" style="padding-top: 0vh;">
      ...
      <div class="pagetitle" style="margin-left: 20px;">
          <h1>Manage Wrokflow Group</h1>
          <nav>
          <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Home</a></li>
              <li class="breadcrumb-item active"><a> Manage Workflow group</a></li>
          </ol>
          </nav>
      </div>
                  ...
                  <table class="table table-border datatable " style="border: 1px solid black">
                    <thead>
                      <tr >
                        ...
                        <th scope="col">wfg_id</th>
                        <th scope="col">Workflow Group</th>
                        <th scope="col">Workflow Group Code</th>
                    ...
                    <tbody>
                      @foreach ($workflows as $workflow =>$item )
                      <tr>
                        <th >{{ $workflow + 1 }}</a></th>
                        <th >{{ $item->id }}</a></th>
                        <td>{{ $item->workflow }}</td>
                        ...
                        <td><form action="" method="POST">
                          ...
                          <a class="btn btn-primary" href="{{route('workflowgroup.edit',$item->id)}}">Edit</a>
