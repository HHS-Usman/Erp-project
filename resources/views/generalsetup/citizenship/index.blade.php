                  ...
                  <table class="table table-border datatable " style="border: 1px solid black">
                    <thead>
                      <tr >
                        ...
                        <th scope="col">Citizenship Code</th>
                    ...
                    <tbody>
                      @foreach ($citizenships as $citizenship =>$item )
                      <tr>
                        <th >{{ $citizenship + 1 }}</a></th>
                        <th >{{ $item->id }}</a></th>
                        <td>{{ $item->citizenship }}</td>
                        <td><a  class="datatable-sorter"></a>{{ $item->citizenship_code }}</td>
                        <td>{{ $item ->detail }}</td>
                        ...
                        <td><form action="" method="POST">
                          ...
                          <a class="btn btn-primary" href="{{route('citizenship.edit',$item->id)}}">Edit</a>
