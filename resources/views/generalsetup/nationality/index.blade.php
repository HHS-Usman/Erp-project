...
@section('content')
    ...
    <section id="main" class="main" style="padding-top: 0vh;">
      ...
      <div class="pagetitle" style="margin-left: 20px;">
          <h1>Manage Nationality</h1>
          <nav>
          <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Home</a></li>
              <li class="breadcrumb-item active"><a> Manage Nationality</a></li>
          </ol>
          </nav>
      </div>
              ...
              <div class="row justify-content-center" >
                <div class="card-body">  
                  <table class="table table-border datatable " style="border: 1px solid black">
                    ...
                    <tbody>
                      @foreach ($nationalities as $nationality =>$item )
                      <tr>
                        <th >{{ $nationality + 1 }}</a></th>
                        <th >{{ $item->id }}</a></th>
                        <td>{{ $item->nationality }}</td>
                        <td><a  class="datatable-sorter"></a>{{ $item->nationality_code }}</td>
                        <td>{{ $item ->detail }}</td>
                        ...
                        <td><form action="" method="POST">
                          ...
                          <a class="btn btn-primary" href="{{route('nationality.edit',$item->id)}}">Edit</a>
