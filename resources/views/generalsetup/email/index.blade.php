    ...
    <section id="main" class="main" style="padding-top: 0vh;">
      ...
      <div class="pagetitle" style="margin-left: 20px;">
          ...
          <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active"><a> Manage Email</a></li>
          </ol>
          </nav>
      </div>
                  ...
                  <table class="table table-border datatable " style="border: 1px solid black">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <th >{{ $item->id }}</a></th>
                        <td>{{ $item->email }}</td>
                        <td><a  class="datatable-sorter"></a>{{ $item->email_code }}</td>
                        <td>{{ $item ->detail }}</td>
                        ...
                        <td><form action="" method="POST">
                          ...
                          <a class="btn btn-primary" href="{{route('email.edit',$item->id)}}">Edit</a>
