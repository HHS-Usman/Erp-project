              ...
              <div class="row justify-content-center" >
                <div class="card-body">  
                  <table class="table table-border datatable " style="border: 1px solid black">
                    ...
                    <tbody>
                      @foreach ($fundtions as $function =>$item )
                      <tr>
                        <th >{{ $function + 1 }}</a></th>
                        <th >{{ $item->id }}</a></th>
                        <td>{{ $item->function }}</td>
                        <td><a  class="datatable-sorter"></a>{{ $item->function_code }}</td>
                        <td>{{ $item ->detail }}</td>
                        ...
                        <td><form action="" method="POST">
                          ...
                          <a class="btn btn-primary" href="{{route('function.edit',$item->id)}}">Edit</a>
