        ...
        @endif
            <div class="pagetitle" style="margin-left: 20px;">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a> Edit Division</a></li>
                </ol>
                </nav>
            </div>
            <br><br><br>
        ...
        <div class="row justify-content-center">
            <div class="col-xs-6 col-sm-6 col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="division_code" id="division_code"  value="{{ $division->division_code }}"  class="form-control"  placeholder="Division Code">
                </div>
                <div class="form-group">
                    <strong>Division<span style="color:#DC3545">*</span></strong>
                    <input type="text" name="division" id="division" class="form-control" value="{{ $division->division }}" placeholder="Division" required>
                </div>
                <div class="form-group">
