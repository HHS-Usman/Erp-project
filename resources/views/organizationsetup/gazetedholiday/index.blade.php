...
@section('content')
    ...
    <section id="main" class="main" style="padding-top: 0vh;">
      ...
      <div class="pagetitle" style="margin-left: 20px;">
          <h1>Manage Gazeted Holiday</h1>
          <nav>
          <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Home</a></li>
              <li class="breadcrumb-item active"><a> Manage Gazeted Holiday</a></li>
          </ol>
          </nav>
      </div>
                  ...
                  <table class="table table-border datatable " style="border: 1px solid black">
                    <thead>
                      <tr >
                        ...
                        <th scope="col">GH_id</th>
                        <th scope="col">Gazeted Holiday</th>
                        <th scope="col">Gazeted Holiday Code</th>
                    ...
                    <tbody>
                      @foreach ($gazetedholidays as $gazetedholiday =>$item )
                      <tr>
                        <th >{{ $gazetedholiday + 1 }}</a></th>
                        <th >{{ $item->id }}</a></th>
                        <td>{{ $item->gazetedholiday }}</td>
                        <td><a  class="datatable-sorter"></a>{{ $item->gazetedholiday_code }}</td>
                        <td>{{ $item ->detail }}</td>
