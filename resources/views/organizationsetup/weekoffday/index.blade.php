                  ...
                  <table class="table table-border datatable " style="border: 1px solid black">
                    <thead>
                      <tr >
                        ...
                        <th scope="col">WeekOff_id</th>
                        <th scope="col">Week Off Day</th>
                        <th scope="col">Week Off Day Code</th>
                    ...
                    <tbody>
                      @foreach ($weekoffdays as $weekoffday =>$item )
                      <tr>
