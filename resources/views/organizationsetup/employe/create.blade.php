    ...
    <div class="pagetitle" style="margin-left: 20px;">
      ...
      <body>
        <div class="container">
          <div class="wrapper">
            <div class="tabs">
              <div style="margin:9px;" ><button type="button" class="btn btn-primary p-3 px-5  col-12" onclick="showTab(1)">Personal Information</button></div>
              <div style="margin:9px;" ><button type="button" class="btn btn-primary p-3 px-5  col-12" onclick="showTab(2)">Company Information</button></div>
              <div style="margin:9px;" ><button type="button" class="btn btn-primary p-3 px-5  col-12" onclick="showTab(3)">PayRoll/Overtime</button></div>
              <div style="margin:9px;" ><button type="button" class="btn btn-primary p-3 px-5  col-12" onclick="showTab(4)">Document/Job History</button></div>
            </div>
              ...
              <form class="w-100" action="{{ route('employees.store') }}" method="POST">
                ...
                <div class="container d-flex justify-content-center align-items-center">
                  <div class="form-group">
                    ...
                    <input
                    type="text" class="form-control" name="employee_name" id="employee_name" placeholder="Employee Name" required/>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <select id="skilllevel" name="skilllevel">
                      ...
                      @foreach($skilllevels as $item)
                        <option value="{{ $item->id }}">{{ $item->skilllevel }}</option>
                      @endforeach
                    </select>
                  </div>
                </div>
