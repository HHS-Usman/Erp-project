                  ...
                  <div class="container d-flex justify-content-center align-items-center">
                        ...
                        <div class="container d-flex justify-content-center align-items-center">
                          <div class="form-group">
                            ...
                            <label for="document_name">Document Name</label>
                              <input type="text" class="form-control" name="document_name" id="document_name" value="{{ old('document_name', $employed->document->document_name) }}" placeholder="Document Name" />
                          </div>
                          <div class="form-group">   
                          <div id="fileupload">
                        ...
                        <div class="container d-flex justify-content-center align-items-center">
                          ...
                          <div class="form-group">   
                            ...
                            <input type="date" class="form-control" name="document_expiredate" id="document_expiredate" placeholder="Document Expired date" value="{{ old('document_expiredate', $employed->document->document_expiredate) }}" />
                          </div>
                          <div class="form-group">   
                            <label for="document_remark">Document Remarks : </label>
                            <textarea type="text" class="form-control" name="document_remark"  id="document_remark"  rows="4" cols="130" placeholder="Remarks" >{{ old('document_remark', $employed->document->document_remark) }}</textarea>
                          </div>
                        </div>  
