                ...
                <form class="w-100 row" id="form3" action="{{ route('emp_payroll.store') }}" method="POST">
                  ...
                  <div class="container d-flex justify-content-center align-items-center">
                    <div class="form-group">
                      ...
                      <select  name="costcenter" id="costcenter"  class="options">
                          <option class="options">None</option>
                    ...
                    <div class="form-group">   
                      ...
                      <select  name="bank_name" id="bank_name"  class="options">
                          <option class="options">None</option>
                  ...
                  <div class="container d-flex justify-content-center align-items-center">
                    <div class="form-group">   
                      ...
                      <select  name="company_bank" id="company_bank"  class="options">
                          <option class="options">None</option>
                        @foreach($banks as $item)
