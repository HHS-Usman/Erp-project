...
@section('content')
    ...
    <section id="main" class="main" style="padding-top: 0vh;">
      ...
      <div class="pagetitle" style="margin-left: 20px;">
          <h1>Manage Leaving Reason</h1>
          <nav>
          <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Home</a></li>
              <li class="breadcrumb-item active"><a> Manage Leaving Reason</a></li>
          </ol>
          </nav>
      </div>
                  ...
                  <table class="table table-border datatable " style="border: 1px solid black">
                    <thead>
                      <tr >
                        ...
                        <th scope="col">Leavingreason_id</th>
                        <th scope="col">Leaving Reason</th>
                        <th scope="col">Leaving Reason Code</th>
                    ...
                    <tbody>
                      @foreach ($leaveresons as $leavingreason =>$item )
                      <tr>
                        <th >{{ $leavingreason + 1 }}</a></th>
                        <th >{{ $item->id }}</a></th>
                        <td>{{ $item->leavingreason }}</td>
                        <td><a  class="datatable-sorter"></a>{{ $item->leavingreason_code }}</td>
                        <td>{{ $item ->detail }}</td>
                        ...
                        <td><form action="" method="POST">
                          ...
                          <a class="btn btn-primary" href="{{route('leavereson.edit',$item->id)}}">Edit</a>
