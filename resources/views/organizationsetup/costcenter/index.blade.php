              ...
              <div class="row justify-content-center" >
                <div class="card-body">  
                  <table class="table table-border datatable " style="border: 1px solid black">
                    ...
                    <tbody>
                      @foreach ($costcenters as $costcenter =>$item )
                      <tr>
                        <th >{{ $costcenter + 1 }}</a></th>
                        <th >{{ $item->id }}</a></th>
                        <td>{{ $item->costcenter }}</td>
                        <td><a  class="datatable-sorter"></a>{{ $item->costcenter_code }}</td>
                        <td>{{ $item ->detail }}</td>
                        ...
                        <td><form action="" method="POST">
                          ...
                          <a class="btn btn-primary" href="{{route('costcenter.edit',$item->id)}}">Edit</a>
