    ...
    <section id="main" class="main" style="padding-top: 0vh;">
      ...
      <div class="pagetitle" style="margin-left: 20px;">
          ...
          <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active"><a> Manage Languages</a></li>
          </ol>
          </nav>
      </div>
                  ...
                  <table class="table table-border datatable " style="border: 1px solid black">
                    <thead>
                      <tr >
                        ...
                        <th scope="col">Lang_id</th>
                        <th scope="col">Languages</th>
                        <th scope="col">Languages Code</th>
                    ...
                    <tbody>
                      @foreach ($languages as $langugage =>$item )
                      <tr>
                        <th >{{ $langugage + 1 }}</a></th>
                        <th >{{ $item->id }}</a></th>
                        <td>{{ $item->language }}</td>
                        <td><a  class="datatable-sorter"></a>{{ $item->language_code }}</td>
                        <td>{{ $item ->detail }}</td>
                        ...
                        <td><form action="" method="POST">
                          ...
                          <a class="btn btn-primary" href="{{route('language.edit',$item->id)}}">Edit</a>
