        ...
        <form action="{{ route('financailyear.store') }}" method="POST">
            ...
            <div class="row justify-content-center">
                <div class="col-md-4 form-group">
                    ...
                    <input type="text" class="form-control" disabled id="customcode" name="customcode" placeholder="0">
                </div>
                <div class="col-xs-6 col-sm-6 col-md-8" style="border: 1px solid black;padding:20px;margin:10px">
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group">
                            ...
                            <select name="buyertype" id="buyertype" class="form-control"> 
                                ...
                                <option value=>{{$item->buyertype}}</option>
                            @endforeach
                            </select>
                        </div>
                        <div class="col-md-6 form-group">
                            ...
                            <select name="buyercategory" id="buyercategory" class="form-control">
                                ...
                                <option value=>{{$item->buyercategory}}</option>
                            @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="text" class="form-control" id="buyerdiscount" name="buyerdiscount" placeholder="buyer Discount">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="text" class="form-control" id="buyeradvance" name="buyeradvance" placeholder="buyer Advance">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group">
                            ...
                            <select name="buyerlocality" id="buyerlocality" class="form-control">
