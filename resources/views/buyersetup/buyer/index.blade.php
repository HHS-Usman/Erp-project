    ...
    <section id="main" class="main" style="padding-top: 0vh;">
      ...
      <div class="pagetitle" style="margin-left: 20px;">
          ...
          <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active"><a> Manage Buyer</a></li>
          </ol>
          </nav>
      </div>
                  ...
                  <table class="table table-border datatable " style="border: 1px solid black">
                    <thead>
                      <tr >
                        ...
                        <th scope="col">Credit Advance</th>
                        <th scope="col">Title</th>
                        <th scope="col">Display Note Invoice</th>
                        <th scope="col">Suplier Locality</th>
                        <th scope="col">Account Title</th>
                        <th scope="col">Action</th>
                      </tr>
                    </thead>
                    <tbody>
                    @foreach ($buyer as $buyer=>$item)
                      <tr>
                        <td>{{$buyer+1}}</td>
                        <td>{{$item->buyer_id}}</td>
                        ...
                        <td>{{$item->buyeradvance}}</td>
                        <td>{{$item->title}}</td>
                        <td>{{$item->dispnote_invoice}}</td>
                        <td>{{$item->suplierlocality}}</td>
