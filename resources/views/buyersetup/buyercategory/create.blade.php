                    ...
                    <div class="row justify-content-center">
                        <div class="col-xs-6 col-sm-6 col-md-6">
                            ...
                            <strong class="form-group">Buyer Category Code</strong>
                                <input type="text" name="buyercategorycode" id="buyercategorycode" class="form-control" placeholder="Buyer Category Code">
                            </div>
                            <div class="form-group">
                                <strong>Buyer Category<span style="color:#DC3545">*</span></strong>
                                <input type="text" name="buyercategory" id="buyercategory" class="form-control" placeholder="Buyer Category" required>
                            </div>
                            <div class="form-group">
