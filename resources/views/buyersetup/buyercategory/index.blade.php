...
<section id="main" class="main" style="padding-top: 0vh;">
    ...
    <div class="pagetitle" style="margin-left: 20px;">
        <h1> Manage Buyer Categoty</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Home</a></li>
                <li class="breadcrumb-item active"><a> Manage Buyer Category</a></li>
            </ol>
        </nav>
    </div>
            ...
            <table class="table table-border datatable " style="border: 1px solid black">
                <thead>
                    <tr>
                        ...
                        <th scope="col">buyercategory_id</th>
                        <th scope="col">Buyer Category Code</th>
                        <th scope="col">Buyer Category</th>
