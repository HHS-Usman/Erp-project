              ...
              <div class="row justify-content-center" >
                <div class="card-body">  
                  <table class="table table-border datatable " style="border: 1px solid black">
                    ...
                    <tbody>
                      @foreach ($employeejobs as $employeejob =>$item )
                      <tr>
                        <th >{{ $employeejob + 1 }}</a></th>
                        <th >{{ $item->id }}</a></th>
                        <td>{{ $item->employeejobstatus }}</td>
                        <td><a  class="datatable-sorter"></a>{{ $item->employeejobstatus_code }}</td>
                        <td>{{ $item ->detail }}</td>
                        ...
                        <td><form action="" method="POST">
                          ...
                          <a class="btn btn-primary" href="{{route('employeejobstatus.edit',$item->id)}}">Edit</a>
