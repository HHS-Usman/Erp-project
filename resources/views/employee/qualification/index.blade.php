    ...
    <section id="main" class="main" style="padding-top: 0vh;">
      ...
      <div class="pagetitle" style="margin-left: 20px;">
          ...
          <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active"><a> Manage Qualification</a></li>
          </ol>
          </nav>
      </div>
                  ...
                  <table class="table table-border datatable " style="border: 1px solid black">
                    <thead>
                      <tr >
                        ...
                        <th scope="col">Qualification_id</th>
                    ...
                    <tbody>
                      @foreach ($qualifications as $qualification =>$item )
                      <tr>
                        <th >{{ $qualification + 1 }}</a></th>
                        <th >{{ $item->id }}</a></th>
                        <td>{{ $item->qualification }}</td>
                        <td><a  class="datatable-sorter"></a>{{ $item->qualification_code }}</td>
                        <td>{{ $item ->detail }}</td>
                        ...
                        <td><form action="" method="POST">
                          ...
                          <a class="btn btn-primary" href="{{route('qualification.edit',$item->id)}}">Edit</a>
