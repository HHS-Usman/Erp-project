        ...
        @endif
            <div class="pagetitle" style="margin-left: 20px;">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a> Create Qualification</a></li>
                </ol>
                </nav>
            </div>
            <br><br><br>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xs-6 col-sm-6 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="qualification_code" id="qualification_code" class="form-control" placeholder="Qualification Code">
                            </div>
                            <div class="form-group">
