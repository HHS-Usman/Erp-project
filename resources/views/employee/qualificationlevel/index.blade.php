...
@section('content')
    ...
    <section id="main" class="main" style="padding-top: 0vh;">
      ...
      <div class="pagetitle" style="margin-left: 20px;">
          <h1>Manage Qualification Level</h1>
          <nav>
          <ol class="breadcrumb">
                  ...
                  <table class="table table-border datatable " style="border: 1px solid black">
                    <thead>
                      <tr >
                        ...
                        <th scope="col">Qualificationlvl_id</th>
                        <th scope="col">Qualification Level</th>
                        <th scope="col">Qualification Level Code</th>
                    ...
                    <tbody>
                      @foreach ($qualificationlevels as $qualificationlevel =>$item )
                      <tr>
                        <th >{{ $qualificationlevel + 1 }}</a></th>
                        <th >{{ $item->id }}</a></th>
                        <td>{{ $item->qualificationlevel }}</td>
                        <td><a  class="datatable-sorter"></a>{{ $item->qualificationlevel_code }}</td>
                        <td>{{ $item ->detail }}</td>
                        ...
                        <td><form action="" method="POST">
                          ...
                          <a class="btn btn-primary" href="{{route('qualificationlevel.edit',$item->id)}}">Edit</a>
