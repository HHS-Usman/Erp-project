                  ...
                  <table class="table table-border datatable " style="border: 1px solid black">
                    <thead>
                      <tr >
                        ...
                        <th scope="col">Emprule_id</th>
                        <th scope="col">Employee rule</th>
                        <th scope="col">Employee rule Code</th>
                    ...
                    <tbody>
                      @foreach ($employeerules as $employeerule =>$item )
                      <tr>
                        <th >{{ $employeerule + 1 }}</a></th>
                        <th >{{ $item->id }}</a></th>
                        <td>{{ $item->employeerule }}</td>
                        <td><a  class="datatable-sorter"></a>{{ $item->employeerule_code }}</td>
                        <td>{{ $item ->detail }}</td>
                        ...
                        <td><form action="" method="POST">
                          ...
                          <a class="btn btn-primary" href="{{route('employeerule.edit',$item->id)}}">Edit</a>
