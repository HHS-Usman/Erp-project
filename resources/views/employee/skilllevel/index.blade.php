                  ...
                  <table class="table table-border datatable " style="border: 1px solid black">
                    <thead>
                      <tr >
                        ...
                        <th scope="col">Skilllvl_id</th>
                        <th scope="col">Skill Level</th>
                        <th scope="col">Skill Level Code</th>
                    ...
                    <tbody>
                      @foreach ($skilllevels as $skilllevel =>$item )
                      <tr>
                        <th >{{ $skilllevel + 1 }}</a></th>
                        <th >{{ $item->id }}</a></th>
                        <td>{{ $item->skilllevel }}</td>
                        <td><a  class="datatable-sorter"></a>{{ $item->skilllevel_code }}</td>
                        <td>{{ $item ->detail }}</td>
                        ...
                        <td><form action="" method="POST">
                          ...
                          <a class="btn btn-primary" href="{{route('skilllevel.edit',$item->id)}}">Edit</a>
