                        ...
                        <div class="col-md-12 form-group">
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-12"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 form-group">
                                        ...
                                        <input type="text" class="form-control" id="supplieradvance"
                                            name="suplieradvance" placeholder="Supplier Advance">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 form-group">
                                        <strong>ZIP/Postal Code</strong>
                                        <input type="text" class="form-control" id="postalcodeon"
                                            name="zip_code_shpping" placeholder="ZIP/Postal Code">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 form-group">
                                        ...
                                        <select name="shipping_country_id" id="shippingcountryon" class="form-control">
                    ...
                    <div class="tab" id="tab2">
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-12" style="border: 1px solid black;padding:20px;margin:10px">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group">
                                    <strong>Contact Person Cell no#</strong>
                                    <input type="text" class="form-control" id="personcell#" name="cont_p_no"
