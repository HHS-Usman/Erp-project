                ...
                <div>
                    <div class=" d-flex col-md-12" >
                        ...
                        <div style="margin-left: 20px;">
                            <table class="table col-md-12" style="border:1px solid rgb(2, 2, 2)">
                    ...
                    <div class="d-flex">
                        ...
                        <div  class="col-md-5">
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea class="form-control" id="bulkMemo" placeholder="Description" style="height:40vh" name="bulkMemo" rows="5" cols="20"></textarea>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div>
                            <table id="mytable" class="table table-border datatable " style="border: 1px solid black">                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    for ($i = 1; $i <= 20; $i++) {
                                        ...
                                        echo "    <td scope='col'>" . rand(2000, 2022) . "</td>\n";
                                        echo "    <td scope='col'>" . date('M', mktime(0, 0, 0, rand(1, 12), 1)) . "</td>\n";
                                        echo "    <td scope='col'>PI-" . rand(100, 999) . "</td>\n";
                                        echo "    <td scope='col'>" . rand(1000, 9999) . "</td>\n";
                                        echo "    <td scope='col'>" . rand(100000, 999999) . "</td>\n";
                                        echo "    <td scope='col'>" . rand(10000, 99999) . "</td>\n";
                                        echo "    <td scope='col'>\n";
                                        echo "        <div class='form-check'>\n";
                                        echo "            <input class='form-check-input' type='checkbox' value='1' name='is_active' id='is_active' checked>\n";
                                        echo "        </div>\n";
                                        echo "    </td>\n";
                                        echo "    <td scope='col'>" . rand(10000, 200000) . "</td>\n";
                                        echo "    <td scope='col'>" . rand(1, 30) . "</td>\n";
                                        echo "    <td scope='col'>" . rand(0, 100) . "</td>\n";
