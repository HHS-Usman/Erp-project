                ...
                <div class="d-flex">
                        ...
                        <div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="modeofpayment" id="modeofpayment" class="form-control">
                                    <option value="modeofpayment">Cash</option>
                                    <option value="modeofpayment">Cheque</option>
                                </select>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <strong>Doc Creation Date</strong>
                                <input type="text" class="form-control" disabled id="documentdate"
                                    name="documentdate" value="" readonly>
                            </div>
                            <div class="form-group">
                    ...
                    <div style="" class="col-md-8 ">
                        <table class="table col-md-12" style="border:1px solid rgb(2, 2, 2)">
                            ...
                            <tr>
                                <th class="col-4 col-md-4 text-center"><H1>PAYMENT TYPE</H1></th>
                                
                            </tr>
                            <tr>
                                <td class="">
                                    <select name="" id="" class="form-select">
                                        <option value="">Checque</option>
                                        <option value="">Cash</option>
                                    </select>
                                </td>
                                {{-- <textarea class="form-control" id="bulkMemo" 
                                    placeholder="Description" name="bulkMemo" rows="5" cols="5"></textarea> --}}
                            </tr>
                           
                        
                    </table>
                         <div class="form-group">
                           {{-- <strong>Bulk Memo</strong>
