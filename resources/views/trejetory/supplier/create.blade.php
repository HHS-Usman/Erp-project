        ...
        <div class="pagetitle" style="margin-left: 20px;">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a> Create Supplier Payment</a></li>
                </ol>
            </nav>
        </div>
        <br><br><br>
                    ...
                    <div style="margin-left: 10px" class="col-md-5">
                        <div class="form-group">
                            ...
                            <select name="employee" id="employee" class="form-control">
                                <option value="Select Employee" >Select Supplier</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <strong>Dropdown Supplier</strong>
                            <select name="employee" id="employee" class="form-control">
                                <option value="Select Employee" >Dropdown Supplier</option>
                            </select>
                        </div>
                        <div class="form-group">
                    ...
                    <div >
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="creationdate" id="creationdate" class="form-control"
                                placeholder="Supplier Category" placeholder="standard date">
                        </div>
                        <div class="form-group">
