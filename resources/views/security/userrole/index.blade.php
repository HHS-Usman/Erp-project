    ...
    <section id="main" class="main" style="padding-top: 0vh;">
      ...
      <div class="pagetitle" style="margin-left: 20px;">
          ...
          <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active"><a> Manage User Role</a></li>
          </ol>
          </nav>
      </div>
              ...
              <div class="row justify-content-center" >
                <div class="card-body">  
                  <table class="table table-border datatable " style="border: 1px solid black">
                    ...
                    <tbody>
                      @foreach ($userroles as $userrole =>$item )
                      <tr>
                        <th >{{ $userrole + 1 }}</a></th>
                        <th >{{ $item->id }}</a></th>
                        <td>{{ $item->user_role }}</td>
                        <td><a  class="datatable-sorter"></a>{{ $item->user_role_code }}</td>
                        <td>{{ $item ->detail }}</td>
                        ...
                        <td><form action="" method="POST">
                          ...
                          <a class="btn btn-primary" href="{{route('userrole.edit',$item->id)}}">Edit</a>
