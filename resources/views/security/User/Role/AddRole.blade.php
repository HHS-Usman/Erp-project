    ...
    $permissions = Permission::query()
                ...
                ->pluck('id'),
                    ...
                    <tbody>
                            ...
                            <tr>
                                <td><h1>{{ CommonHelper::get_Module_by_name($moduleGroup['main_module']) }}</h1></td>
                                <td><input type="checkbox" name="module_id[]" id="unfreezeToggle-{{$moduleGroup['main_module'] }}" value="{{$moduleGroup['main_module'] }}" onclick="toggleUnfreeze({{ $moduleGroup['main_module'] }})"></td>
                                {{-- <td></td> --}}
                                    @php
                                    ...
                                    <td>
                                        ...
                                        <input type="checkbox" name="page_action_id" id="freezer-{{ $moduleGroup['main_module'] }}" class="item" value="{{$moduleGroup['page_action_id'][$key] }}" data-module="{{ $moduleGroup['main_module'] }}" onclick="freeze('{{ $moduleGroup['main_module'] }}')" checked></td>
                                    @endforeach
                                {{-- <td><input type="checkbox" name="" id="freezer1-{{ $moduleGroup->first()->module->id }}" class="item" value="1" data-module="{{ $moduleGroup->first()->module->id }}" onclick="freeze1('{{ $moduleGroup->first()->module->id }}')" checked></td>
                                <td><input type="checkbox" name="" id="freezer2-{{ $moduleGroup->first()->module->id }}" class="item" value="1" data-module="{{ $moduleGroup->first()->module->id }}" onclick="freeze2('{{ $moduleGroup->first()->module->id }}')" checked></td>
                                <td><input type="checkbox" name="" id="freezer3-{{ $moduleGroup->first()->module->id }}" class="item" value="1" data-module="{{ $moduleGroup->first()->module->id }}" onclick="freeze3('{{ $moduleGroup->first()->module->id }}')" checked></td> --}}
                            </tr>
                            {{-- <tr>
                                <td>Tick All</td>
                                <td><input type="checkbox" name="" id="selectAll-{{ $moduleGroup->first()->module->id }}" class="item" data-module="{{ $moduleGroup->first()->module->id }}" value="1"></td>
                                <td></td>
                                <td><input type="checkbox" name="" id="selectAdd-{{ $moduleGroup->first()->module->id }}" class="item" data-module="{{ $moduleGroup->first()->module->id }}" value="1"></td>
                                <td><input type="checkbox" name="" id="selectView-{{ $moduleGroup->first()->module->id }}" class="item but" data-module="{{ $moduleGroup->first()->module->id }}" value="1"></td>
                                <td><input type="checkbox" name="" id="selectEdit-{{ $moduleGroup->first()->module->id }}" class="item why" data-module="{{ $moduleGroup->first()->module->id }}" value="1"></td>
                                <td><input type="checkbox" name="" id="selectDelete-{{ $moduleGroup->first()->module->id }}" class="item the" data-module="{{ $moduleGroup->first()->module->id }}" value="1"></td>
                            </tr>
                            @foreach ($moduleGroup->groupBy('page.name') as $pageName => $pageGroup)
                                <tr>
                                    <td>{{ $pageName }}</td>
                                    <td><input type="checkbox" name="" id="" class="item example" value="1" data-module="{{ $moduleGroup->first()->module->id }}"></td>
                                    <td></td>
                                    @foreach ($pageGroup as $data)
                                        @if ($data->page_action_id == 1)
                                            <td>
                                                <input type="checkbox" name="page_id[]" id="item_one" class="item example2 not" value="{{ $data->id }}" data-module="{{ $moduleGroup->first()->module->id }}">
                                                {{ $data->name }}
                                            </td>
                                        @elseif ($data->page_action_id == 2)
                                            <td><input type="checkbox" name="page_id[]" id="2ndweek_tue_03" class="item example3 but" value="{{ $data->id }}" data-module="{{ $moduleGroup->first()->module->id }}"></td>
                                        @elseif ($data->page_action_id == 3)
                                            <td><input type="checkbox" name="page_id[]" id="3rdweek_tue_03" class="item example4 why" value="{{ $data->id }}" data-module="{{ $moduleGroup->first()->module->id }}"></td>
                                        @elseif ($data->page_action_id == 4)
                                            <td><input type="checkbox" name="page_id[]" id="4thweek_tue_03" class="item example5 the" value="{{ $data->id }}" data-module="{{ $moduleGroup->first()->module->id }}"></td>
                                        @endif
                                    @endforeach
                                </tr>
                            @endforeach --}}
