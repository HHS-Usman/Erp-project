...
class CreateProductsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('products', function (Blueprint $table) {
            ...
            $table->boolean('expiry')->default(false)->nullable();
            $table->string('expiry_ap');
            $table->boolean('expiry_n')->default(false)->nullable();
            ...
            $table->boolean('fixedasset')->default(false)->nullable();
            $table->boolean('general_product')->default(false)->nullable();
            $table->boolean('product_active')->default(false)->nullable();
            $table->boolean('pqc_required')->default(false)->nullable();
